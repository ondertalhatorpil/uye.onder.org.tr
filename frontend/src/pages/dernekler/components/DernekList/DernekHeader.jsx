    ...
    <div className="p-6 mb-8"> {/* Dark background, border, shadow, padding */}
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
        <div className="mb-6 lg:mb-0">
          <h1 className="text-3xl font-bold text-[#FA2C37] mb-2"> 
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button
            onClick={onRefresh}
            disabled={refreshing}
            className="flex items-center px-4 py-2 bg-[#FA2C37] hover:bg-red-700 text-white rounded-xl font-medium transition-all shadow-md disabled:opacity-50" // Rounded-xl, shadow-md
          >
